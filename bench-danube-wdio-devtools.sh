...
for i in {1..$1}; do
 { echo $i && time ./scripts/wdio-devtools/node_modules/.bin/wdio ./scripts/wdio-devtools/wdio.conf.js } >> results/logs/wdio-webdriver-danube-$1-$2-log.txt 2>> results/performance/wdio-webdriver-danube-$1-$2.txt
