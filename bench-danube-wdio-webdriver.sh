...
for i in {1..$1}; do
 { echo $i && time ./scripts/wdio-selenium/node_modules/.bin/wdio ./scripts/wdio-selenium/wdio.conf.js --spec ./scripts/wdio-selenium/test/specs/danube-login.js } >> results/logs/wdio-danube-$1-$2-log.txt 2>> results/performance/wdio-danube-$1-$2.txt
